...
<body class="bg-light">
  ...
  <div class="my-5 px-4">
    ...
    Khách sạn Mường Thanh cam kết mang đến cho khách hàng những trải nghiệm<br>
  ...
  <div class="container">
    <div class="row justify-content-between align-items-center">
      <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
        <h3 class="mb-3">Khách Sạn Vinh Hotel</h3>
        <p>
        Khách sạn Vinh Hotel là một trong những khách sạn hàng đầu tại Việt Nam,
